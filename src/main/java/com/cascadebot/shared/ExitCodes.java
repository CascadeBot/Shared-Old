...
public final class ExitCodes {
    ...
    public static int ERROR_STOP_NO_RESTART = 24; // Don't restart on stop (Config errors, multiple login failures etc)
    public static int ERROR_STOP_RESTART = 25; // Recoverable error (Restart after stop)
